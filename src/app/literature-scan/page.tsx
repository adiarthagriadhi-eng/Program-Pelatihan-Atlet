...
import LiteratureScanForm from "@/components/literature-scan/LiteratureScanForm";

export const dynamic = "force-dynamic";

export default async function LiteratureScanPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-4 py-10 sm:py-16">
      ...
      <p className="mb-8 text-sm text-zinc-500">
        Cari temuan penelitian sport science terbaru & kredibel untuk topik tertentu. Hasilnya
      ...
      {loadError ? (
        ...
        <LiteratureScanForm athletes={athletes} />
      )}
    </main>
  );
}

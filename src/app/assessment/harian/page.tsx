...
export default async function InputAssessmentHarianPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-md px-4 py-10 sm:py-16">
      ...
      <p className="mb-8 text-sm text-zinc-500">
        Isi cepat kondisi harian atlet: RPE sesi, durasi sesi, jam tidur, dan wellness score.
      </p>
      {loadError ? (
        ...
        <AssessmentForm athletes={athletes} />
      )}
    </main>
  );
}
